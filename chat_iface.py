...
def playehm():
    """Suara cipi ehm"""
    wv,sr = soundfile.read("./sounds/ehm.wav")
    sounddevice.play(wv,samplerate=44100)

def playya():
    """Bilang ya"""
    wv,sr = soundfile.read("./sounds/ya.wav")
    sounddevice.play(wv,samplerate=44100)

def playdetected():
    """Bunyi apabila hotword di detect"""
    wv,sr = soundfile.read("./sounds/Ring09.wav")
    sounddevice.play(wv,samplerate=44100)
    
def playerror():
    """Bilang kalau ada kesalahan internal"""
    wv, sr = soundfile.read("./sounds/error.wav")
    sounddevice.play(wv,samplerate=44100)

def playerror_internet():
    """ Bilang kalau tidak ada internet"""
    wv, sr = soundfile.read("./sounds/error_internet.wav")
    sounddevice.play(wv,samplerate=44100)
